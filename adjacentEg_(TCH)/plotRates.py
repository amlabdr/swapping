...
rates100us = np.loadtxt('adjacentEg_(TCH)/rates/100us.txt')
rates1ms = np.loadtxt('adjacentEg_(TCH)/rates/1ms.txt')
rates10ms= np.loadtxt('adjacentEg_(TCH)/rates/10ms.txt')
rates100ms= np.loadtxt('adjacentEg_(TCH)/rates/100ms.txt')
#rates900ms = np.loadtxt('adjacentEg_(TCH)/rates/900ms.txt')
rates1s= np.loadtxt('adjacentEg_(TCH)/rates/1s.txt')
#rates10s = np.loadtxt('adjacentEg_(TCH)/rates/10s.txt')
ratesinf = np.loadtxt('adjacentEg_(TCH)/rates/inf.txt')
