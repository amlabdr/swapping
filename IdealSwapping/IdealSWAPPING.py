...
networksList = ["networks/3nodes.json","networks/4nodes.json","networks/5nodes.json"]
networksList = ["networks/4nodes.json"]
for network_config in networksList:
    ...
    rates = []
    for L in distances:
        rates.append(simulate(L))
    # Save rates to a file
    filename = "IdealSwapping/rates/"+network+".txt"
    # Save rates to a file
